...
<?php if (($this->params->get('cssCompress')) ==1) : ?>
	<link href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/css/css_compress.php" rel="stylesheet" type="text/css" media="all" />
	...
	<?php if (($this->params->get('css3effects')) ==0) : ?>
...
<?php if (($this->params->get('jsCompress')) ==0) : ?>
	...
	<script type="text/javascript" src="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/js/jq.corner.packed.js"></script>
...
<?php if (($this->params->get('customCss')) ==1) : ?>
